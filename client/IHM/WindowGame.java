...
public class WindowGame extends BasicGameState {
	...
	public static Image bonusVitesse;
	public static Image bonusTeteChercheuse;
	public static Image bonusTripleMissile;
	public static Image bonusShield;
	...
	public void init(GameContainer container, StateBasedGame sgb) throws SlickException {
		...
		try {
			...
			bonusVitesse = new Image("ressources/sprites/PW/bolt_gold.png");
			bonusTeteChercheuse = new Image("ressources/sprites/PW/powerupGreen_star.png");
			bonusShield = new Image("ressources/sprites/PW/shield_gold.png");
			bonusTripleMissile = new Image("ressources/sprites/PW/star_gold.png");
